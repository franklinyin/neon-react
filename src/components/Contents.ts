...
export const insertTabHtml: Record<string, string> = {
  ...
  /*  "<p class='control'>" +
        ...
        '<p class=\'control\'>' +
        '<button id=\'gClef\' class=\'button insertel smallel\' aria-label=\'G Clef\' title=\'G Clef\'><img src=\'' + __ASSET_PREFIX__ + 'assets/img/GClef.svg' + '\' class=\'image\'/></button></p>',
...
export const clefActionContents: string =
    ...
    '<a id=\'GClef\' class=\'dropdown-item\'>G Clef</a></div></div></div></div>';
